...
class ProductTemplate(models.Model):
    ...
    detailed_desc = fields.Html(string="Detailed Description")
    faqs = fields.Html(string="FAQs")
    benefits_of_plants = fields.Html(string="Benefits")
    product_classifier_type = fields.Selection([
        ('plant', 'Plant'),
        ('pot', 'Pot'),
        ('potting_mix', 'Potting Mix'),
        ('other', 'Other'),
    ], string="Product Classifier")
