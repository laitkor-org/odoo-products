...
class ProductTemplate(models.Model):
    ...
    soil_type = fields.Char(string="Supported Soil Types")
    water_frequency = fields.Char(string="Frequency of Watering")
    amount_of_sunlight = fields.Char(string="Sunlight Required")
    native_place = fields.Char(string="Native To")
    common_names = fields.Char(string="Common names")
    care_instructions = fields.Html(string="Instructions for care")
