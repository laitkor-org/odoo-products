...
class AccountTax(models.Model):
    ...
    @api.model
    def _prepare_tax_totals(self, base_lines, currency, tax_lines=None, is_company_currency_requested=False, delivery_charge=0.0):
        ...
        return {
            ...
            'formatted_delivery_charge': formatLang(self.env, delivery_charge, currency_obj=currency),
        }
