...
from addons.delivery_post.controllers.controllers import DeliveryPost
...
class Users(models.Model):
    ...
    def _login(cls, db, login, password, user_agent_env):
        ...
        # Some code that might be used for future references
        # instantiated an object of the DeliveryPost class and called the method for generating access token
        # accessTokenObj = DeliveryPost()
        # credentials for testing access token API endpoint
        # tokenResponse = accessTokenObj.generateAccessToken("testcustomer","testing")
        # tokenResponse = accessTokenObj.generateAccessToken(login,password)
        # status_code = tokenResponse.get('status_code')
        # if(status_code == 200):
            # for testing purposes
            # _logger.info("Working fine")
        # else:
            # for testing purposes
            # _logger.info("Error")
        return user.id
